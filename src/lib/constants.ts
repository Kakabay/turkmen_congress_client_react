...
export const sectionsTranslations = {
  en: {
    ...
    upcomingEvent: {
      ...
      eventTitle: 'Commercial, Investment and Business opportunities in Turkmenistan 2024',
  ...
  ru: {
    ...
    upcomingEvent: {
      ...
      eventTitle: 'Коммерческие, инвестиционные и бизнес возможности в Туркменистане',
